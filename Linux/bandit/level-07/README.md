...
Learn how to search inside files using grep to find a specific key/value pair.
...
\- How to use grep to search inside files

\- How to match a specific string pattern
