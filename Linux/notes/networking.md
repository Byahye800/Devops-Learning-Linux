...
Shows network interfaces, assigned IP addresses, and link status.
...
Displays interface information on older systems (legacy alternative to ip).
...
Tests network connectivity and measures response time.
...
64 bytes from 142.250.187.78: icmp\_seq=1 ttl=115 time=12.3 ms
...
Retrieves data from a web address; useful for testing APIs or endpoints.
...
(wget prints progress output, but no “success” message — this is normal)
...
Looks up DNS information to help diagnose name resolution issues.
...
Shows active network connections, listening ports, and associated processes.
...
tcp   LISTEN  0.0.0.0:22           1023/sshd

tcp   LISTEN  127.0.0.1:5432       1500/postgres
...
2  10.10.0.1         5.234 ms

3  142.250.187.78   12.345 ms
